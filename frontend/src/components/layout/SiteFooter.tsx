      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-8 md:py-10 grid gap-8 md:grid-cols-3">
        ...
        <nav aria-label="Навигация" className="space-y-3">
          ...
          <ul className="space-y-2 text-sm font-bold">
            <li><Link href="/find" className="hover:text-brand transition-colors">Найти специалиста</Link></li>
        ...
        <div className="space-y-3">
          ...
          <ul className="space-y-2 text-sm font-bold">
            <li>
              <a href="mailto:hello@stroik.app" className="inline-flex items-center gap-2 hover:text-brand transition-colors">
                <Mail size={14} /> hello@stroik.app
              </a>
            </li>
            <li>
              <a href="https://github.com/nkVas1/stroik-platform" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 hover:text-brand transition-colors">
