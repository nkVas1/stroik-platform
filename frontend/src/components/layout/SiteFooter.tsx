...
/**
 * Единый футер публичных страниц.
 * Минималистичный, чтобы не отвлекать от CTA. Адаптивный, без зависимостей от темы фона.
 */
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-8 md:py-10 grid gap-8 md:grid-cols-3">
        ...
        <nav aria-label="Навигация" className="space-y-3">
          ...
          <ul className="space-y-2 text-sm font-bold">
            ...
            <li>
              <Link href="/onboarding" className="hover:text-brand transition-colors">
                Регистрация через ИИ
              </Link>
            </li>
            <li>
