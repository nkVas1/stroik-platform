...
import { HardHat, Briefcase, Search, ShieldCheck, LogOut, User as UserIcon, Building, CheckCircle, XCircle, Clock, Star } from 'lucide-react';
...
export default function DashboardPage() {
  ...
  const handleAcceptBid = async (bidId: number) => {
    ...
    try {
      ...
      if (res.ok) {
        alert("✅ Исполнитель назначен! Проект в работе.");
        window.location.reload();
      }
    } catch (e) { alert("Ошибка сети"); }
  };
